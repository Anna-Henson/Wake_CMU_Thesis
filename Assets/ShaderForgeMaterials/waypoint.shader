...
////// Emissive:
                ...
                float3 emissive = (( _Color.rgb > 0.5 ? (node_227.rgb + 2.0*_Color.rgb -1.0) : (node_227.rgb + 2.0*(_Color.rgb-0.5)))*node_1515);
                float3 finalColor = emissive;
                float node_8765 = (node_1515+0.1);
                fixed4 finalRGBA = fixed4(finalColor,(node_8765*_OpacityClip));
