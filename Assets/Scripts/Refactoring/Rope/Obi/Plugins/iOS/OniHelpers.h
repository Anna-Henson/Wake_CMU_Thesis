...
namespace Oni
{
    extern "C"
    {
        ...
        EXPORT void GetPointCloudAnisotropy(Eigen::Vector3f* points,int count,float max_anisotropy,float radius,QuaternionfUnaligned& orientation,Eigen::Vector3f& principal_values);
    }
