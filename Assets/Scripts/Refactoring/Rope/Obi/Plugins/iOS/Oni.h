...
namespace Oni
{
    ...
    extern "C"
    {
        ...
        EXPORT int SetParticleOrientations(Solver* solver,const float* orientations, int num, int dest_offset);
        
        EXPORT int GetParticleOrientations(Solver* solver, float* orientations, int num, int source_offset);
        ...
        EXPORT int SetParticlePrincipalRadii(Solver* solver, const Vector2fUnaligned* radii,int num, int dest_offset);
        ...
        EXPORT int SetParticleAngularVelocities(Solver* solver,const float* velocities, int num, int dest_offset);
        
        EXPORT int GetParticleAngularVelocities(Solver* solver, float* velocities, int num, int source_offset);
        ...
        EXPORT void AddParticleExternalTorques(Solver* solver, const Vector4fUnaligned* torques, int* indices, int num);
        
        EXPORT void AddParticleExternalTorque(Solver* solver, const Vector4fUnaligned& torque, int* indices, int num);
